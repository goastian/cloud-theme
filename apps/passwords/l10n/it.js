OC.L10N.register(
    "passwords",
    {
        ...
        "JavaScript JIT might be disabled in your browser in order to render web content in a more secure configuration. You can always enable Javascript JIT in the settings, depending on your web browser.": "JavaScript JIT is disabled by default in the browser in order to render web content in a more secure configuration. È sempre possibile attivare Javascript JIT nelle impostazioni. <br /><br /><p><b>Passi per il browser eOS:</b> Fare clic sull'icona con i tre puntini in alto a sinistra e andare su:<div class=\"quote\">Impostazioni > Impostazioni del sito</div>Quindi, attivate <b>Javascript JIT</b> in fondo all'elenco.</p>"
   },
